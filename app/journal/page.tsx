...
function JournalPageContent() {
    const { users, journalPosts, books, addJournalPost, updateJournalPost, deleteJournalPost, updateUserName, addComment, deleteComment, materialTags, globalFilterTags, setGlobalFilterTags, currentUser } = useReading();
